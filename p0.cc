...
typedef shrinkMatrix<num_t, p0_10t> p0_11t;
// N.B. we take average as origin of input.
typedef sumChain<num_t, p0_11t, true> p0_t;
...
typedef shrinkMatrix<num_t, p0_s6t> p0_s7t;
typedef sumChain<num_t, p0_s7t, true> p0_st;
...
int main(int argc, const char* argv[]) {
  ...
  p0_st q;
  if(var < 0)
    q = p0_st(p0_s7t(p0_s6t(p0_s5t(p0_s4t(p0_s3t(p0_s2t(p0_1t(p0_0t(step, abs(var * 2)), abs(var)) )) ) )), abs(var)));
  else
    p = p0_t(p0_11t(p0_10t(p0_9t(p0_8t(p0_7t(p0_6t(p0_5t(p0_4t(p0_3t(p0_2t(p0_1t(p0_0t(step, abs(var * 2)), abs(var)), step), step), step), step) )) ) )), abs(var)) );
  num_t d(int(0));
  auto  Mx(d);
  auto  M(d);
