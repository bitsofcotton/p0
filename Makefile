...
clean:
	@rm -rf p0 p0-32 p0r p0r32 p0l p0l32
all:	p0 p0-32 p0r p0r32 p0l p0l32
p0:
	${CXX} ${CXXFLAGS} -static -O0 -o p0 p0.cc
p0-32:
	${CXX} ${CXXFLAGS} -static -D_FLOAT_BITS_=32 -O0 -o p0-32 p0.cc
p0-64:
	${CXX} ${CXXFLAGS} -static -D_FLOAT_BITS_=64 -O0 -o p0-32 p0.cc
p0r:
...
p0l:
	${CXX} ${CXXFLAGS} -static -o p0l p0l.cc
p0l32:
	${CXX} ${CXXFLAGS} -static -D_FLOAT_BITS_=32 -o p0l32 p0l.cc
p0l64:
	${CXX} ${CXXFLAGS} -static -D_FLOAT_BITS_=64 -o p0l64 p0l.cc
