...
clean:
	@rm -rf p0 p0-32 p0j p0j32 p0r p0r32
all:	p0 p0-32 p0j p0j32 p0r p0r32
p0:
...
p0j:
	${CXX} ${CXXFLAGS} -D_JAM_ -static -O0 -o p0j p0.cc
p0j32:
	${CXX} ${CXXFLAGS} -static -D_JAM_ -D_FLOAT_BITS_=32 -O0 -o p0j32 p0.cc
p0j64:
	${CXX} ${CXXFLAGS} -static -D_JAM_ -D_FLOAT_BITS_=64 -O0 -o p0j64 p0.cc
p0r:
